...
public class HomeServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        List<Application> top4appListPaid =ad.getListAppOrderBySalary();
        List<Application> top4appListFree =ad.getListAppOrderByDown();

        List<Application> topLatestApp = ad.getListAppOrderByDate();
        ...
        request.setAttribute("appList", new ArrayList<>(appList));
        request.setAttribute("devList", devList);
        request.setAttribute("cateList", cateList);
        List<Images> imgList = ad.getListImg();
        request.setAttribute("imgList", imgList);
        request.setAttribute("topAppList", top4appListPaid);
        request.setAttribute("topAppListFree", top4appListFree);
        
        request.setAttribute("topLatestApp", topLatestApp);

        HttpSession session = request.getSession();
        List<Category> cata = ad.getListCate();
        List<Developer> dev = ad.getListDeveloper();
        session.setAttribute("cate", cata);
