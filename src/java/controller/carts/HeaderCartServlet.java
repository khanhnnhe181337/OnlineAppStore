 ...
 * @author ADMIN
 */
@WebServlet(name = "CartServlet", urlPatterns = {"/header"})
public class HeaderCartServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        //request lôi cookies về dạng chuỗi []
        ...
        response.sendRedirect("product?id=" + appid);
        // Chuyển tiếp request và response tới order.jsp
    }
