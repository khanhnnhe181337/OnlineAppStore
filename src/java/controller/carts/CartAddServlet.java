 ...
 * @author ADMIN
 */
@WebServlet(name="CartAddServlet", urlPatterns={"/cardAdd"})
    ...
    throws ServletException, IOException {        
        ...
        if (session == null) {
            ...
            if (cartItems==null||cartItems.isEmpty()) {
                System.out.println("CART LIST NOT EXIST!!.");
        ...
        request.getRequestDispatcher("cardShop.jsp").forward(request, response);
    } 
